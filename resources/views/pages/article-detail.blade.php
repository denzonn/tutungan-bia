                ...
                <div class="container">
                    ...
                    <div class="row">
                                    ...
                                    <div class="news-date">
                                        <div class="social-share">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <a href="https://www.facebook.com/sharer/sharer.php?u={{ route('detail-artikel', $data->slug) }}"
                                                    target="_blank" class="facebook"><i
                                                        class="fa-brands fa-facebook"></i></a>
                                                <a href="https://twitter.com/intent/tweet?url={{ route('detail-artikel', $data->slug) }}"
                                ...
                                <div class="news-contributor-editor">
                                    ...
                                    <div class="contributor-editor">
                                        ...
                                        <div class="news-editor">
                                            <div>Editor : {{ $data->articleEditor->name }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 d-none d-lg-block">
                            <div class="d-flex">
                                <h3 class="mb-15">Artikel Terpopuler</h3>
                            </div>
                        ...
                        <div class="row">
                            ...
                            @forelse ($readAlso as $index => $item)
                                <div class="col-lg-3 col-md-6">
                                    <a href="{{ route('detail-artikel', $item->slug) }}" class="news-detail">
